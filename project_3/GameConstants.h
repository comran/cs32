...
const double SPRITE_WIDTH_GL = .5;  // note - this is tied implicitly to
                                    // SPRITE_WIDTH due to carey's sloppy openGL
                                    // programming
const double SPRITE_HEIGHT_GL = .5;  // note - this is tied implicitly to
                                     // SPRITE_HEIGHT due to carey's sloppy
                                     // openGL programming
