...
struct NavSegment {
 public:
  ...
  NavSegment(std::string direction, std::string streetName, double distance,
             const GeoSegment &gs)
      : m_command(PROCEED),
...
inline double angleBetween2Lines(const GeoSegment &line1,
                                 const GeoSegment &line2) {
  double angle1 = atan2(line1.end.latitude - line1.start.latitude,
                        line1.end.longitude - line1.start.longitude);
  double angle2 = atan2(line2.end.latitude - line2.start.latitude,
...
inline double angleOfLine(const GeoSegment &line1) {
  double angle = atan2(line1.end.latitude - line1.start.latitude,
                       line1.end.longitude - line1.start.longitude);
